...
def train(epoch):
    ...
    for data in train_loader:
        ...
        # 修正标签值，确保它们在有效范围内
        data.y[data.y >= Num_Class] = Num_Class - 1  # 将超出范围的标签归为 Num_Class-1
...
for run_ind in range(1, Num_Run+1):  #Multiple runs of self-supervised learning.
